...
public:
	static inline const SaveLoad description[] = {
		...
		converted correctly */
		SLE_CONDVAR(Vehicle, current_order.type,    SLE_FILE_U8 | SLE_VAR_U16,    SL_MIN_VERSION,   SLV_5),
		SLE_CONDVAR(Vehicle, current_order.dest,    SLE_FILE_U8  | SLE_VAR_U16,   SL_MIN_VERSION,   SLV_5),

		/* Orders for version 5 and on */
		SLE_CONDVAR(Vehicle, current_order.type,    SLE_FILE_U8 | SLE_VAR_U16,    SLV_5, SL_MAX_VERSION),
